...
function add2Cart(product,butOff) {
    
    //change button image
    document.getElementById(butOff).src='add-to-cart-button2.gif';
    
    //set timer to reset the image
    setTimeout(function(){
        document.getElementById(butOff).src='add-to-cart-button1.gif';
},200);
